...
import numpy as np
import pytest
from min_llm.data import get_batch
...
def test_get_batch():
    ...
    data_gen = get_batch(dataset, batch_size, context_length, device = device)
    ...
    with pytest.raises((RuntimeError, AssertionError)) as excinfo:
        ...
        # being handled.
        data_gen = get_batch(dataset, batch_size, context_length, device = "cuda:99")
